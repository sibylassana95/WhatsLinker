      ...
      <div class="space-y-6">
        ...
        <footer class="text-center mt-8 pb-8">
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400">
            © ${new Date().getFullYear()} WhatsLinker. Créé par <a href="https://lassanasiby.com" class="text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-500 transition-colors">Siby Lassana</a>. Tous droits réservés.
          </p>
        </footer>
      </div>
    </div>
